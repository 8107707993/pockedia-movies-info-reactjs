...
const AddIcon = ({type,elements}) => {
  ...
  let storeFavourite = favouritelist.find((o) => o.id === elements.id);

  const disebleWatchlit = storeWatchlist ? true : false;
  const disebleWatched = storeWatched ? true : false;
  const disebleFavourite = storeFavourite ? true : false;
    ...
    {type === "WatchList" && (
              ...
              {type === "genral" && (
                <>
                  ...
                  <button
                    disabled={disebleFavourite}
                    onClick={() => addfavouriteMovie(elements)}
                    data-bs-toggle="tooltip"
                    data-bs-placement="top"
              ...
              {type === "favourite" && (
                <>
                  <button
                    onClick={() => removeFromFavourite(elements.id)}
                    data-bs-toggle="tooltip"
                    data-bs-placement="top"
                    title="Add To Watched "
                    className="btn "
